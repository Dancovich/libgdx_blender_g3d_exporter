...
class G3DBaseExporterOperator(ExportHelper, IOG3DOrientationHelper):
    ...
    def convertVectorCoordinate(self, co):
        ...
        Util.debug(None, "|=[Converting coordinates from [%s, %s, %s] to [%s, %s, %s]]=|"
                   % (Util.floatToString(None, co[0]), Util.floatToString(None, co[1]), Util.floatToString(None, co[2]), Util.floatToString(None, newCo[0]), Util.floatToString(None, newCo[1]), Util.floatToString(None, newCo[2])))
    ...
    def convertQuaternionCoordinate(self, co):
        ...
        Util.debug(None, "|=[Converting quaternion from format [w, x, y, z] [%s, %s, %s, %s] to format [x, y, z, w] [%s, %s, %s, %s]]=|"
                   % (Util.floatToString(None, co[0]), Util.floatToString(None, co[1]), Util.floatToString(None, co[2]), Util.floatToString(None, co[3]), Util.floatToString(None, newCo[0]), Util.floatToString(None, newCo[1]), Util.floatToString(None, newCo[2]), Util.floatToString(None, newCo[3])))
